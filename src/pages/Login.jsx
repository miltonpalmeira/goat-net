    ...
    return (
        <section className="bg-gray-50 dark:bg-gray-900">
            ...
            <div className="flex flex-col items-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                <a className="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white mt-20">
                    ...
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 md:space-y-6" action="#">
                            ...
                            <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                Deseja criar uma conta? <a href="#" className="font-medium text-primary-600 hover:underline dark:text-primary-500">Cadastrar-se</a>
                            </p>
                        </form>
                    </div>
                </div>
